...
def parse_map_text(filepath: str) -> Dict[str, Any]:
    ...
    Parse les informations (nb de drones, hubs, connections)
    et stocke tout dans un dict.
    """
    ...
    if not os.path.exists(filepath):
        print(f"Erreur (parsing text) : Le fichier '{filepath}'"
              "est introuvable.")
        return map_data
    ...
    with open(filepath, 'r', encoding='utf-8') as file:
        for line_num, line in enumerate(file, start=1):
            ...
            try:
                    ...
                    if attr_match:
                        ...
                        for attr in attr_str.split():
                            if '=' in attr:
                                ...
                                attributes[key] = int(value) if value.isdigit(
                                    ) else value
                            else:
                ...
                print(f"Avertissement : Ligne {line_num} ignorée ou mal "
                      f"formattée -> '{line}' ({e})")
