...
# Forcer le focus pour que les touches de deplacement marchent
        ...
        self.score_label_trans.setScale(0.08)
        self.score_label_trans.setTranslation(QVector3D(-3.0, 0.5, 0.06))
        ...
        self.time_label_trans.setScale(0.08)
        ...
        self.score_val_trans.setScale(0.15)
        self.score_val_trans.setTranslation(QVector3D(-2.5, -0.6, 0.06))
        ...
        self.time_val_trans.setScale(0.15)
        self.time_val_trans.setTranslation(QVector3D(2.0, -0.6, 0.06))
        ...
        self.start_text_trans.setScale(0.08)
        self.start_text_trans.setTranslation(QVector3D(-1.5, -0.2, 0.06))
